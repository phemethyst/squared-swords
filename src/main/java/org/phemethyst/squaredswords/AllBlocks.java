...
import org.phemethyst.squaredswords.content.kinetics.SquaredSwordsGeneratorBlock;
import org.phemethyst.squaredswords.content.kinetics.SquaredSwordsKineticBlock;
...
public class AllBlocks {
     ...
     */
    public static final BlockEntry<SquaredSwordsKineticBlock> EXAMPLE_KINETIC_BLOCK = SquaredSwords.REGISTRATE
            .block("squaredswords_kinetic_block", SquaredSwordsKineticBlock::new)
     ...
     * registered in SquaredSwords. The transform call attaches the EXAMPLE_SOURCE display
     * source to this block.
     */
    public static final BlockEntry<SquaredSwordsGeneratorBlock> EXAMPLE_GENERATOR_BLOCK = SquaredSwords.REGISTRATE
            .block("squaredswords_generator_block", SquaredSwordsGeneratorBlock::new)
     ...
     * axis so the shaft rendered by SquaredSwordsShaftRenderer visibly pokes out of both ends.

 ...
 */
public class SquaredSwordsShaftRenderer<T extends KineticBlockEntity> extends KineticBlockEntityRenderer<T> {

    public SquaredSwordsShaftRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }

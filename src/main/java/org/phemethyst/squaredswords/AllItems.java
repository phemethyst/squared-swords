 ...
 * or remove the override and add assets/squaredswords/textures/item/name.png.
 */
public class AllItems {

    public static final ItemEntry<Item> EXAMPLE_ITEM = SquaredSwords.REGISTRATE
            .item("squaredswords_item", Item::new)
     ...
     */
    public static final ItemEntry<Item> EXAMPLE_RESULT = SquaredSwords.REGISTRATE
            .item("squaredswords_result", Item::new)
     ...
     */
    public static final ItemEntry<Item> INCOMPLETE_EXAMPLE = SquaredSwords.REGISTRATE
